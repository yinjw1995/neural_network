...
- mini-batch的核心算法如图![image](https://github.com/yinjw1995/neural_network/blob/master/note_pictures\1.jpg)
...
- 如果考虑极端的情况，每一个batch的尺寸为m，则只有一个，我们可以称之为batch梯度下降，如果是尺寸为1，则有m个，这就是随机梯度下降
  ...
  ![2](https://github.com/yinjw1995/neural_network/blob/master/note_pictures\2.png)

  ![3](https://github.com/yinjw1995/neural_network/blob/master/note_pictures\3.png)
...
- **Mini-batch 大小的选择**
  ...
  ![4](https://github.com/yinjw1995/neural_network/blob/master/note_pictures\4.png)
